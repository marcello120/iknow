...
app.controller('todoController', function TodoCtrl($scope, $location, $firebaseArray, $firebaseObject, $firebaseObject, $http) {
  ...
  $scope.random = new URLSearchParams(window.location.search).get('random');
